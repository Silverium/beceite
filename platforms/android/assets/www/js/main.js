;(function () {
	...
	var featuresAnimate = function() {
		...
		if ( $('#fh5co-features2').length > 0 ) {
			$('#fh5co-features2 .to-animate').each(function( k ) {
	...
	var featuresWayPoint = function() {
		...
		if ( $('#fh5co-features2').length > 0 ) {
			$('#fh5co-features2').waypoint( function( direction ) {
	...
	var productsAnimate = function() {
		...
		if ( $('#fh5co-products2').length > 0 ) {
			$('#fh5co-products2 .to-animate').each(function( k ) {
	...
	var productsWayPoint = function() {
		...
		if ( $('#fh5co-products2').length > 0 ) {
			$('#fh5co-products2').waypoint( function( direction ) {
	...
	var faqsAnimate = function() {
		...
		if ( $('#rutas_acordeon').length > 0 ) {
			$('#rutas_acordeon .to-animate').each(function( k ) {
	...
	var faqsWayPoint = function() {
		...
		if ( $('#rutas_acordeon').length > 0 ) {
			$('#rutas_acordeon').waypoint( function( direction ) {
